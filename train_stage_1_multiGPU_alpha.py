...
class Net(nn.Module):
    ...
    def forward(
        ...
        ref_image_latents,
        clip_image_embeds,
        clip_fused_embeds, #add clip fused embeds
        pose_img,
        ...
        if not uncond_fwd:
            ...
            self.reference_unet(
                ...
                encoder_hidden_states2=clip_fused_embeds,
                return_dict=False,
            )
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(net):
                ...
                with torch.no_grad():
                    ...
                    alpha = 0.00001
                    fused_prompt_embeds = image_prompt_embeds + alpha*complex_prompt_embeds
                ...
                model_pred = net(
                    ...
                    ref_image_latents,
                    image_prompt_embeds,
                    fused_prompt_embeds, #add complex prompt embeds
                    tgt_pose_img,
                    uncond_fwd,
                )
