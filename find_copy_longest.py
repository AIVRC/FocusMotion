...
OUTPUT_DIR = "/home/yanghaotian/server_data/yanghaotian/data/fd_distinct/videos"
...
for group, files in sorted(groups.items()):
    ...
    src_path = os.path.join(VIDEO_DIR, max_file)
    dst_path = os.path.join(OUTPUT_DIR, max_file)
